...
class ConsoleView(object):
    ...
    def printRotation(self, rotation):
        ...
        self.printNewline(1)
        print(self.pattern.format("Rotation", rotation[0], rotation[1], rotation[2], rotation[3]))
        #print self.pattern.format("Rotation ", **rotation)

    def printTranslation(self,translation):
        print(self.pattern.format(" ", "G", "D", "M", "S"))
        self.printNewline(1)
        print(self.pattern.format("Translation ", translation[0], translation[1], translation[2], translation[3]))
